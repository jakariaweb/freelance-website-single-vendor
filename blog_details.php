...
$get_blog = "SELECT * FROM blog WHERE blog_url='$blog_id'";

$run_blog = $db->select($get_blog);

if($run_blog){
    
$check_blog = mysqli_num_rows($run_blog);
...
?>
    ...
    <div class="row">
        <div class="col-md-12">
            <img class="card-img-top" src="admin_login/<?php echo $blog_image; ?>" alt="<?php echo substr($blog_title, 0, 20)?>" style="width:100%; height: 650px;">  <br> <br>
            
             <h5 class="font-weight-bold"><?php echo $blog_title; ?></h5>
            
            <p class=""><?php echo $blog_desc; ?></p>
