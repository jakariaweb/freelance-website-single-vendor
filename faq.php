                ...
                <div class="row">
                    <div class="col-md-12">
                         ...
                         <h2>Frequently asked questions</h2>
                          ...
                          ?>
                            <button class="accordion"><?php echo $homefAQ['home_faq_title'];?></button>
                            <div class="panel">
                              <p><?php echo $homefAQ['home_faq_desc'];?></p>
                            </div>
                            
                        <?php }}else{echo "No FAQ Added Yet"; }?>
